...
export default function App() {
  ...
  const revealImage = "https://tor.cloud.appwrite.io/v1/storage/buckets/6a764a9e001950932add/files/6a7651fa002274e60700/preview?project=6a759bd5002ae569ab96&impersonateuserid=&token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0b2tlbklkIjoiNmE3NjUyMTE2OGI4YzQ3ZTY4NDciLCJyZXNvdXJjZUlkIjoiNmE3NjRhOWUwMDE5NTA5MzJhZGQ6NmE3NjUxZmEwMDIyNzRlNjA3MDAiLCJyZXNvdXJjZVR5cGUiOiJmaWxlcyIsInJlc291cmNlSW50ZXJuYWxJZCI6Ijc3NDo0IiwiaWF0IjoxNzg2MTM5MTUzfQ.M2HDyXB5ZMi_6AH_tU6WeF7pFSUjSPz4bnwi1mdxPAk";
